namespace Crud
{
	partial class Stanowisko
	{
		...
		private void InitializeComponent()
		{
			...
			this.fKstanowiskidst618671AFBindingSource = new System.Windows.Forms.BindingSource(this.components);
			...
			((System.ComponentModel.ISupportInitialize)(this.fKstanowiskidst618671AFBindingSource)).BeginInit();
			this.SuspendLayout();
			// 
			// dataGridView1
			// 
			...
			this.dataGridView1.Size = new System.Drawing.Size(564, 392);
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(695, 314);
			...
			// textBox1
			// 
			this.textBox1.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.stanowiskoBindingSource, "nazwa", true));
			...
			// textBox2
			// 
			this.textBox2.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.stanowiskoBindingSource, "pensja", true));
			this.textBox2.Location = new System.Drawing.Point(609, 161);
			...
			// 
			// fKstanowiskidst618671AFBindingSource
			// 
			this.fKstanowiskidst618671AFBindingSource.DataMember = "FK__stanowisk__id_st__618671AF";
			this.fKstanowiskidst618671AFBindingSource.DataSource = this.stanowiskoBindingSource;
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.fKstanowiskidst618671AFBindingSource)).EndInit();
		...
		private System.Windows.Forms.BindingSource fKstanowiskidst618671AFBindingSource;
